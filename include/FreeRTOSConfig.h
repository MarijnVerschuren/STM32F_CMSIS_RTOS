...
/* The following flag must be enabled only when using new-lib */
#define configUSE_NEWLIB_REENTRANT						0

/* Set the following definitions to include the API functions */
...
#ifdef __NVIC_PRIO_BITS  // defined when CMSIS is used
...
extern void RTOS_tick_handler(void);  // function called from SysTick_Handler
